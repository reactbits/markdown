...
var Content = function (_Component) {
  ...
  _createClass(Content, [{
    ...
    value: function replaceBlocks() {
      var root = $(_reactDom2.default.findDOMNode(this)); // eslint-disable-line
    ...
    value: function render() {
      ...
      var className = _githubMarkdown2.default['markdown-body'];
      return _react2.default.createElement('span', { className: className, dangerouslySetInnerHTML: { __html: html } }); // eslint-disable-line
    }
  }]);
